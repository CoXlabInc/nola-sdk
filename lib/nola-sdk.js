...
export default {
  ...
  provideBuilder() {
    ...
    var controlPanel = this.controlPanelView;
    ...
    return class NolABuildProvider {
      ...
      settings() {
        ...
        if (os.platform() == 'linux' || os.platform() == 'darwin') {
          config.exec = app.getPath('home') + path.sep + '.atom' + path.sep + 'nola-sdk' + path.sep + 'make' + path.sep + 'build.sh';
        } else {
          config.exec = app.getPath('home') + path.sep + '.atom' + path.sep + 'nola-sdk' + path.sep + 'make' + path.sep + 'build.cmd';
        }
