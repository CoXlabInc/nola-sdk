...
export default class UpdateLibraryView {
  ...
  doUpdate() {
    ...
    //console.log('name:' + libName + ', type:' + libType + ', newVer:' + libNewVer + ', libToolchain:' + libToolchain);
    if (libNewVer == 'DELETE') {
      ...
      https.get(url + libType, (response) => {
        ...
        this.writer.on('finish', () => {
          ...
          zipFile.on('close', () => {
            ...
            //   chmodr.chmodSync(filePath + "make", 0o755);
            // }
            ...
            if (this.libVersions.length == 0) {
              ...
              for (var x = 0; x < this.libVersions.length; x++) {
                console.log('1[' + x + ']' + this.libVersions[x].libName);
              }
            } else {
              ...
              if (j >= this.libVersions.length) {
                ...
                for (var x = 0; x < this.libVersions.length; x++) {
                  console.log('2[' + x + ']' + this.libVersions[x].libName);
                }
              }
            }
