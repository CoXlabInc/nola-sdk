...
export default class ControlPanelView {
  ...
  constructor(serializedState) {
    ...
    this.btnClose.classList.add('icon-triangle-up');
  ...
  refreshBuild() {
    atom.config.set('nola-sdk.build', this.currentProjectPath + '|' + this.devSelectView.curDev.libType + '|' + this.portSelectView.curPort);
  }
}
